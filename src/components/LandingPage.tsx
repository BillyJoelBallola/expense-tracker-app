...
export default async function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-neutral-50 dark:bg-neutral-950 text-neutral-950 dark:text-white">
      {/* Background */}
      <div
        className="absolute inset-0 z-0"
        style={{
          backgroundImage: `
        linear-gradient(to right, #7373734f 1px, transparent 1px),
        linear-gradient(to bottom, #7373734f 1px, transparent 1px)
      `,
